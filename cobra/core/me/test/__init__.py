...
salmonella_sbml = __join(data_directory, "salmonella_m_fbc.xml")
salmonella_pickle = __join(data_directory, "salmonella_m_dnf.pickle")
...
def create_test_model(test_pickle=salmonella_pickle):
    ...
    try: 
        ...
        raise Exception("Not set up to load ME Models from SBML")
